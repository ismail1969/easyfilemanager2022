...
public class ImageViewerPanel_New extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
	/**
	 * 
	 */
	...
	public ImageViewerPanel_New(String[] pFilenames, int pFitWidth, int pFitHeight) throws InterruptedException {
		super();
